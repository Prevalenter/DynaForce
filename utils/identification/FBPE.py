...
from utils.support_funcs.utils import skew, mrepl
from lmi_sdp import LMI_PD, LMI

from algorithm.OLS import LeastSquares
...
def FBPE_OLS(W, omega, R1, rho1, rbt):
	dof = rbt.dof
...
if __name__ == '__main__':
	...
	# print(omega.shape)
	# breakpoint()
	beta_init, beta_star = FBPE_OLS(W, omega, R1, rho1, rbt)
